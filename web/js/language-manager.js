// ============================================================================
// TELECOM X - LANGUAGE MANAGER (ACTUALIZADO)
// Manages i18n translations and theme toggle
// ============================================================================
...
class LanguageManager {
    ...
    async init() {
        ...
        this.updateUI();
        this.setupThemeToggle(); // 🔧 Cambio: setupDarkMode → setupThemeToggle
    }
    ...
    // 🔧 NUEVO: Theme Toggle (Oscuro por defecto, Light Mode para claro)
    setupThemeToggle() {
        const themeToggle = document.getElementById('darkModeToggle');
        
        // 🔧 IMPORTANTE: La página es OSCURA por defecto
        // Si hay 'light-mode' guardado, aplicarlo
        ...
        if (themeToggle) {
            themeToggle.addEventListener('click', () => {
                ...
                // Evento para que otros componentes se enteren
                ...
                console.log(`🎨 Theme changed to: ${isNowLight ? 'LIGHT' : 'DARK'}`);
            });
        }
    }
}
